...
const SocialHeader = ({
  userName, image, userColor, logo, showLoginIcon, urlSuffix, isMaster,
}) => {
  ...
  return (
    <Box className={classes.container}>
      ...
      <Box
        ...
        style={{ maxHeight: width / 2, backgroundColor: !loading && image && !storageImageError ? 'transparent' : userColor }}
