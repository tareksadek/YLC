...
import AddToHomeScreen from '../Onboarding/AddToHomeScreen'
...
import { getInvitationByCode, getPatchInvitations, generateInvitaionCode } from '../../API/invitations'
...
const Landing = ({
  ...
  const [infoForm, setInfoForm] = useState({
    ...
    lastName: createFormElementObj('input',
      auth.isMaster ? pageStatics.forms.stepOne.teamName : pageStatics.forms.stepOne.lastName,
      {
        type: 'text',
        name: 'lastName',
        placeholder: auth.isMaster ? pageStatics.forms.stepOne.teamName : pageStatics.forms.stepOne.lastName,
      },
    ...
    jobTitle: createFormElementObj('input',
      auth.isMaster ? pageStatics.forms.stepOne.teamPosition : pageStatics.forms.stepOne.jobTitle,
      {
        type: 'text',
        name: 'jobTitle',
        placeholder: auth.isMaster ? pageStatics.forms.stepOne.teamPosition : pageStatics.forms.stepOne.jobTitle,
      }, '', null, { required: false }, false,
      {
        xs: 12,
        sm: null,
  ...
  }, [invitationTheme, invitationColorName, invitationColorCode, configueringInvitations])
